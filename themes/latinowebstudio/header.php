...
echo '<div class="align-items-center d-md-flex h-100">';
echo '<a href="' . home_url() . '" title="Real Estate Justin, partner up with Justin on your first deal" style="padding:12px 0px" class="d-block">';
...
// echo '</div>';
echo '<div class="col-lg-6 col-md-8 col-12 text-lg-right text-center text-white d-md-flex align-items-center justify-content-md-end justify-content-center" style="padding:0px;">';
...
echo '<div class="d-flex align-items-center justify-content-md-end justify-content-center">';
...
echo '<a href="https://getcreativepodcast.com/" target="_blank" class="btn-main outline white" style="font-size:12px;padding:5px 5px;" title="Listen to the Creative Podcast with Justin"><svg style="width:12px;height:12px;margin-right:7px;fill:white;transition:all .25s ease-in-out;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2023 Fonticons, Inc. --><path d="M256 80C149.9 80 62.4 159.4 49.6 262c9.4-3.8 19.6-6 30.4-6c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48c-44.2 0-80-35.8-80-80V384 336 288C0 146.6 114.6 32 256 32s256 114.6 256 256v48 48 16c0 44.2-35.8 80-80 80c-26.5 0-48-21.5-48-48V304c0-26.5 21.5-48 48-48c10.8 0 21 2.1 30.4 6C449.6 159.4 362.1 80 256 80z"/></svg>Get Creative Podcast</a>';
echo do_shortcode('[button href="/contact/" title="Fill out a contact form to invest with Justin" style="font-size:12px;padding:5px 5px;" class="outline"]Invest with Justin[/button]');
